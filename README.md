...
```
cd existing_repo
git remote add origin https://gitlab.com/salahbm/mobile-wallet2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/salahbm/mobile-wallet2/-/settings/integrations)
